        ...
        <div className="glass-card px-4 sm:px-6 py-2 sm:py-3 animate-fade-in w-full sm:w-auto">
          <div className="flex items-center gap-2 sm:gap-3 justify-center">
            <div className="relative">
              <div className="animate-spin rounded-full h-5 w-5 sm:h-6 sm:w-6 border-4 border-primary border-t-transparent"></div>
              <div className="absolute inset-0 rounded-full bg-primary/20 animate-ping"></div>
            </div>
            <span className="text-gray-300 font-semibold text-sm sm:text-base">Desbloqueando en {timeLeft} segundos...</span>
          </div>
          <div className="mt-3 h-2 bg-dark-900 rounded-full overflow-hidden border border-white/5">
            <div 
              className="h-full bg-gradient-to-r from-primary to-accent transition-all duration-1000 ease-linear shadow-[0_0_10px_rgba(255,107,53,0.5)]"
